...
@interface QHNewsView()<WKScriptMessageHandler, WKNavigationDelegate, WKUIDelegate>
...
-(WKWebView *)webView {
    if (!_webView) {
        ...
        NSURL *url = [NSURL URLWithString:self.viewModel.url];  //测试本地H5
