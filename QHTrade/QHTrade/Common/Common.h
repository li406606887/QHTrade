...
#define NoSafeBarHeight  [UserInformation getInformation].noSafeBarHeight
...
//#define HostUrlBak               @"http://192.168.0.8:8080"
#define HostUrlBak               @"http://118.31.103.102:8080"
